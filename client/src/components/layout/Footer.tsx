                ...
                <div className="mt-24 pt-12 border-t border-border space-y-6">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                        <p className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground">
                            © 2022 Choudhary Yamaha. Excellence Synchronized. <span>|</span> <Link href="https://github.com/himesh220002/" target="_blank" rel="noopener noreferrer" className="text-racing-blue hover:text-racing-blue transition-colors">Digitally Empowered by Himesh</Link>
                        </p>
